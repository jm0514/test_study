...
class OrderStatisticsServiceTest {
    ...
    void sendOrderStatisticsMail(){
        ...
        Order order1 = createPaymentComplementOrder(LocalDateTime.of(2023, 3, 4, 23, 59, 59), products);
        Order order2 = createPaymentComplementOrder(now, products);
        Order order3 = createPaymentComplementOrder(LocalDateTime.of(2023, 3, 5, 23, 59, 59), products);
        ...
        // when
        boolean result = orderStatisticsService.sendOrderStatisticMail(LocalDate.of(2023, 3, 5), "test@test.com");
